...
# 只做三件事：把五個 proto 的指令放進 PATH、決定遊樂場放哪、決定 daemon 的家。
_AOS_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]:-${(%):-%x}}")/.." && pwd)"
export AOS_ROOT="$_AOS_ROOT"
export PATH="$AOS_ROOT/proto4-3:$AOS_ROOT/proto4-4:$AOS_ROOT/proto4-5:$AOS_ROOT/proto4-6:$AOS_ROOT/proto4-7:$HOME/.local/bin:$PATH"
