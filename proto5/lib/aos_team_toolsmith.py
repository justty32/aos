...
這個檔留生工具包與牢裡試跑（測試換掉這裡的 TOOL_TIMEOUT_MS、jail_ok）、郵差端與人端；草稿欄位驗分在 aos_team_toolsmith_check。
"""
import argparse
import copy
import hashlib
...
import aos_team_ask
from aos_team_format import Layout, TeamError, load_roster, next_number, now_iso, read_json, write_json

from aos_team_toolsmith_check import check_body, FIELDS, MAX_CODE
