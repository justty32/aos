...
```sh
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=proto5/lib python3 -m unittest discover -s proto5/lib/test  # 2665 條；repo 根目錄
```
...
共 96 個測試檔、2665 條（第三波 W3-1 隊收尾在 main f353297 之上實跑，全綠，約 4 分鐘）；涵蓋底層執行、daemon／kernel 按池行為、
