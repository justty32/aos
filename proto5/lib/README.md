...
```sh
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=proto5/lib python3 -m unittest discover -s proto5/lib/test  # 2865 條；repo 根目錄
```
...
共 101 個測試檔、2865 條（09-25 市場公式修正後，main 172ad67 之上實跑，全綠）；涵蓋底層執行、daemon／kernel 按池行為、
