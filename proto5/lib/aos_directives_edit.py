...
這個檔留人格的各指令（ls／show／set／add／rm／export／import／versions／revert）與命令列；
人格檔與分節、resolve／check 分在 aos_directives_edit_persona／resolve。
"""
import os
import sys
import time
...
from aos_directives_edit_persona import (
    label, LAST, parse, pick, prelude_end, read_persona, replace_body, section_text, system_path,
    versions, write_persona
)
from aos_directives_edit_resolve import check_value, cmd_check, cmd_resolve
