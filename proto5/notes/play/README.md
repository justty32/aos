...
| one-boot | 2026-09-24 | `aos up`／`aos down` 合一開關機之後：只拿 README＋教程 01、02、06 照抄（開機、kernel 跑工作、手寫 agent 家、第二個 kernel 共用 daemon 與故意撞名）、README 五分鐘 agent、daemon 閒時與忙時各 kill -9 再 `aos up` | [Opus](2026-09-24-one-boot-opus.md) | Opus 5/4/4/4/4 |
