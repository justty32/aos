...
agent 線三份規範（[agent.md](../spec/agent/README.md)、[aos-agent.md](../spec/aos-agent/README.md)、[aos-llm.md](../spec/aos-llm/README.md)）09-24 定稿並實作後，`proto5/backlog/` 六個檔逐一判掉，資料夾拿掉。
