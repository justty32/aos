...
1. **〔必修〕write／edit 的暫存檔可經符號連結覆寫根目錄外檔案。**  
   **位置：** [_common.py:118](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/tools/base/_common.py:118)。  
...
2. **〔必修〕`realpath` 檢查與實際 I/O 分離，不能保證併發情況下不越界。**  
   **位置：** [_common.py:96](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/tools/base/_common.py:96)、`write:17`、`read:23`、`edit:22`、`grep:49`、`find:63`、`ls:21`。  
...
3. **〔必修〕grep 繼承 ripgrep 設定，靜態符號連結也可能越界。**  
   **位置：** [grep:18](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/tools/base/grep:18)。  
...
4. **〔必修〕grep 的逾時失效，stderr 還可能造成死鎖；逾時也可能被報成無匹配。**  
   **位置：** [grep:52](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/tools/base/grep:52)、`aos_exec.py:474`。  
   **現象／推理：**
...
5. **〔必修〕`--force` 不是整包原子更新，崩潰可能留下舊 schema 配缺失或新版程式。**  
   **位置：** [aos_agent_tools.py:71](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/lib/aos_agent_tools.py:71)、`spec/aos-agent/tools.md:31`。  
...
6. **〔必修〕輸出上限不等於讀取資源上限，read／edit／grep 可先耗盡記憶體。**  
   **位置：** [read:23](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/tools/base/read:23)、`edit:22`、`grep:57`。  
...
7. **〔必修〕bash「背景行程會被殺掉」的承諾超過實作。**  
   **位置：** [bash:25](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/tools/base/bash:25)、`bash:38`、`bash:82`、`base.json:31`。  
...
8. **〔建議〕同檔 edit 與安裝設定更新都有遺失更新的競態。**  
   **位置：** [edit:22](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/tools/base/edit:22)、`aos_agent_tools.py:55`、`:63`、`:93`。  
...
9. **〔建議〕工作根目錄包含 agent 家的警告漏掉符號連結別名。**  
   **位置：** [aos_agent_tools.py:100](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/lib/aos_agent_tools.py:100)、`:117`。  
...
10. **〔建議〕grep fallback 的語法與忽略規則會誤導模型。**  
    **位置：** [base.json:40](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/tools/base/base.json:40)、`grep:27`。  
...
11. **〔建議〕schema 與上限表不完整，read 的 2000 行硬上限也沒有實作。**  
    **位置：** [base.json:4](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/tools/base/base.json:4)、`read:36`、`tools/README.md:29`。  
...
12. **〔建議〕部分非法輸入會漏出 traceback，沒有約定的 JSON 錯誤。**  
    **位置：** [_common.py:29](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/tools/base/_common.py:29)、`bash:25`、`grep:52`。  
...
13. **〔建議〕find 會把走訪失敗包裝成完整的成功結果。**  
    **位置：** [find:63](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/tools/base/find:63)。  
...
14. **〔建議〕工具函式同名有驗，但套件名稱共用檔案命名空間，`--force` 可覆蓋別包。**  
    **位置：** [aos_agent_tools.py:24](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/lib/aos_agent_tools.py:24)、`:48`、`:82`。  
...
15. **〔建議〕相較 pi，主要缺口是多處編輯、換行容錯及截斷後的取回能力。**  
    **位置：** [edit:11](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/tools/base/edit:11)、`read:37`、`bash:44`。  
    **現象／比較：**
...
16. **〔建議〕安裝驗證順序與規範不一致，來源 manifest 還會在驗證後重新讀取。**  
    **位置：** [aos_agent_tools.py:46](/home/lorkhan/repo/simple_tools/aos/.claude/worktrees/agent-a9264eb50d9daee3e/proto5/lib/aos_agent_tools.py:46)、`:90`、`spec/aos-agent/tools.md:26`。  
