...
| [2026-09-24-cli-agents/](2026-09-24-cli-agents/README.md) | **提案**（沒改程式與規範、沒真跑）：Claude Code／Codex 兩支 CLI 納進 kernel／daemon／inst——主方案是「池＋inst 範本＋`aos-cli` 包裝」，不寫新種 cpu；十五個用法、另外四個角色、花錢與權限、astra 必修 11 全改、5 題待拍；＋[stage0.md](2026-09-24-cli-agents/stage0.md)：階 0 做出來（範本、教程 07、五條真跑驗證、一條龍腳本） |
