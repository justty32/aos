...
| [2026-09-24-tool-era/](2026-09-24-tool-era/README.md) | **規劃**（沒改程式與規範）：工具大開發時代——ai_core 九軸對到使用者五句＋「邊界」的評分表、`~/repo/workflows` 化成團隊（三個 agent＋四個機械員）、29 個工具清單、三波開發計畫與任務書骨架；astra 審查；＋[t3/](2026-09-24-tool-era/t3/README.md)（第一波第 3 隊：files／wf 工具包、aos-json、aos-directives）；＋[t1/](2026-09-24-tool-era/t1/README.md)（第一波第 1 隊：spec/team 共用格式、aos-team、成員模板、門房、任務單狀態機、問人、tools/task） |
