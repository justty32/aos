...
**C-1｜在哪：[cpu §6，第 1–2 步](/home/guanyu/projs/aos/proto5/spec/cpu.md:208)／問題：先把對帳依據清掉。**  
...
**C-2｜在哪：[cpu §6，第 2–3 步](/home/guanyu/projs/aos/proto5/spec/cpu.md:209)／問題：兩檔皆無不代表回音沒發出去。**  
...
**C-3｜在哪：[cpu §4.3](/home/guanyu/projs/aos/proto5/spec/cpu.md:150)、[§6](/home/guanyu/projs/aos/proto5/spec/cpu.md:209)／問題：存在沒列出的第四種組合。**  
...
**C-4｜在哪：[cpu §3、§6](/home/guanyu/projs/aos/proto5/spec/cpu.md:86)／問題：刪 request 後，原 JSON-RPC 身分無從恢復。**  
...
**C-5｜在哪：[cpu §5.1–5.2](/home/guanyu/projs/aos/proto5/spec/cpu.md:170)／問題：四個停止來源沒有接成同一個狀態機。**  
...
**C-6｜在哪：[cpu §0、§5.1](/home/guanyu/projs/aos/proto5/spec/cpu.md:28)／問題：EOF 不等於父行程死亡。**  
...
**C-7｜在哪：[cpu §6–7](/home/guanyu/projs/aos/proto5/spec/cpu.md:214)／問題：回音寫不出去，不能再用回音回報。**  
...
**C-8｜在哪：[cpu §0、§3.1](/home/guanyu/projs/aos/proto5/spec/cpu.md:24)／問題：奈秒時間戳不保證名稱唯一。**  
...
**K-1｜在哪：[kernel §3，第 1–2 步](/home/guanyu/projs/aos/proto5/spec/kernel.md:102)／問題：先接鏈仍然會斷鏈。**  
...
**K-2｜在哪：[kernel §3 第 5 步、§6–7](/home/guanyu/projs/aos/proto5/spec/kernel.md:160)／問題：boot 繞過序列化，`--seq` 不是互斥。**  
...
**K-3｜在哪：[kernel §1.2、§3 第 7–8 步](/home/guanyu/projs/aos/proto5/spec/kernel.md:60)／問題：缺少 request 對行程的映射。**  
...
**K-4｜在哪：[kernel §3，第 7–9 步](/home/guanyu/projs/aos/proto5/spec/kernel.md:114)／問題：收件會永久失單，派件會重派。**  
...
**K-5｜在哪：[kernel §3 第 5 步、§5](/home/guanyu/projs/aos/proto5/spec/kernel.md:109)／問題：spawn 結果未知可能產生同家兩個主人。**  
...
**K-6｜在哪：[kernel §3 第 5 步、§5、§8](/home/guanyu/projs/aos/proto5/spec/kernel.md:154)／問題：kernel cpu 不能靠已停掉的鏈重生自己。**  
...
**K-7｜在哪：[kernel §2、§3 第 6 步、§4](/home/guanyu/projs/aos/proto5/spec/kernel.md:87)／問題：once 的接受與延後回音缺少完整生命週期。**  
...
**K-8｜在哪：[kernel §2 rm、§4](/home/guanyu/projs/aos/proto5/spec/kernel.md:88)／問題：rm 後同名重加，舊回音可能污染新行程。**  
...
**K-9｜在哪：[kernel §2 stop、§3](/home/guanyu/projs/aos/proto5/spec/kernel.md:90)／問題：停止後仍可能派工，而且沒有收尾者。**  
...
**K-10｜在哪：[kernel §3、§8 第 1 點](/home/guanyu/projs/aos/proto5/spec/kernel.md:184)／問題：stop 不保證最多等一個 interval。**  
...
**K-11｜在哪：[kernel §4](/home/guanyu/projs/aos/proto5/spec/kernel.md:126)／問題：判定表無法唯一決定計數與退件。**  
...
**K-12｜在哪：[kernel §6](/home/guanyu/projs/aos/proto5/spec/kernel.md:170)／問題：CLI 承諾拿不到的資料。**  
...
**K-13｜在哪：[kernel §1.1、§2](/home/guanyu/projs/aos/proto5/spec/kernel.md:47)／問題：池的合法性不足以保證可排程。**  
...
**X-1｜在哪：[cpu §4.1](/home/guanyu/projs/aos/proto5/spec/cpu.md:128)、[kernel §3](/home/guanyu/projs/aos/proto5/spec/kernel.md:104)／問題：預設 tick 本身不合法。**  
CPU request 的 timeout 只准正整數，但 kernel 明寫 tick `timeout_ms:0`，一般行程預設也是 0；aos-exec 則明定 0＝不限。  
**建議：**統一為非負整數、bool 不算、0＝不限。**嚴重度：擋。**

**X-2｜在哪：[cpu §4.1](/home/guanyu/projs/aos/proto5/spec/cpu.md:128)、[kernel §3 第 8 步](/home/guanyu/projs/aos/proto5/spec/kernel.md:117)／問題：並列 timeout 尚未形成可執行的解析契約。**  
...
**X-3｜在哪：[cpu §4.1](/home/guanyu/projs/aos/proto5/spec/cpu.md:123)、[inst-posix §3.1](/home/guanyu/projs/aos/proto5/spec/inst-posix.md:94)／問題：`base=C` 不等於所有中心固定 C。**  
...
**X-4｜在哪：[cpu §4.1](/home/guanyu/projs/aos/proto5/spec/cpu.md:125)、[load_obj](/home/guanyu/projs/aos/proto5/lib/aos_inst.py:91)／問題：`$ref:""` 的根不是整個 request。**  
...
**X-5｜在哪：[cpu §4.1 result](/home/guanyu/projs/aos/proto5/spec/cpu.md:141)、[aos-exec 退出碼](/home/guanyu/projs/aos/proto5/spec/aos-exec.md:53)／問題：找不到程式的分類改了。**  
...
**X-6｜在哪：[cpu §3、§4.1](/home/guanyu/projs/aos/proto5/spec/cpu.md:80)、inst-posix §3.3／§6／問題：工作串流會撞控制 pipe。**  
...
**X-7｜在哪：[cpu §3、§4.3、§6](/home/guanyu/projs/aos/proto5/spec/cpu.md:82)／問題：合法 notification 被要求回音。**  
...
**X-8｜在哪：[kernel §1.1、§6](/home/guanyu/projs/aos/proto5/spec/kernel.md:53)、directives §1／問題：boot 綁 daemon 會被頂層 `$ref` 吃掉。**  
...
F＝[findings](/home/guanyu/projs/aos/proto5.1/notes/findings.md)；舊 R＝[review-fable](/home/guanyu/projs/aos/proto5.1/notes/review-fable.md)。舊 R1–R3、R5–R9、R14–R27 已在後續修過，以下判的是新草稿是否保留修正；「解了」指規範結構，不代表新實作已驗證。

| 舊項目／來源 | 判定 | 新草稿的效果與剩餘問題 |
|---|---|---|
| [cpu-simpler](/home/guanyu/projs/aos/proto5/backlog/cpu-simpler.md)；F1、8、10、19 | 解了舊機制 | 單一主人消除多 consumer 認領、短鎖、running 搬移、inode 核對；link 正確解決當下同名覆蓋。 |
...
| [request-identity](/home/guanyu/projs/aos/proto5/backlog/request-identity.md)；F11–13、18、23、26；kiss-holes #1、7 | 沒解交易問題 | 獨立回音名稱減少串單，但送件／記帳、收件／記帳仍分離；C-2、K-4、K-7。 |
...
| [kill-tree-exceptions](/home/guanyu/projs/aos/proto5/backlog/kill-tree-exceptions.md)；F28、42 | 沒解，方向已改 | 不做 kill-tree 是既定方向；同 group 個別存活例外並未因此實現。 |
...
| [agent-fail-state](/home/guanyu/projs/aos/proto5/backlog/agent-fail-state.md)；F3、5、6、13、14、21、22、38 | 沒解，屬 agent 後續 | consume、批次讀驗、工具記憶自癒不因 transport 改變自動解決；依前提不列本次阻塞。 |
| kiss-holes #4：其他入口同時跑同一 agent | 沒解，已接受邊界 | 排程行程身分不等於 agent 家的排他；但 boot 自己造成並行不能用此邊界豁免。 |
| [tool-call-order](/home/guanyu/projs/aos/proto5/backlog/tool-call-order.md) | 沒解 | FIFO 派工不等於工具依賴順序，多顆同池 CPU 仍可並行。 |
| [llm-cpu-fallback](/home/guanyu/projs/aos/proto5/backlog/llm-cpu-fallback.md)；F15、24、36 | 沒解，責任移到程式 | pool 不提供 endpoint failover，也不自動提供模型設定與金鑰隔離。 |
