...
| [studio-4](2026-09-07-studio-4.md) | 修掉卡死、每格守額度、再把流程做成工具（studio／pyshop 包），三局實玩 | 4b 寫出 todo.py 且測試全過；4c 新流程接單→派工→自動撥款→回報退回→驗收全自己走，但 dev 模型改不出配測試的程式，沒交付。過程在 [journey](../2026-09-07-studio-journey.md)。 |
