...
← [proto5.1 README](../README.md)｜程式：[aos-cpu](aos-cpu.md)｜payload：[llm-cpu](llm-cpu.md)、[tool-cpu](tool-cpu.md)
...
exactly-once 或歸屬保證。完整情境與後續評估見 [findings](../notes/findings.md)。
