...
[`subprojects/inst/docs/`](../subprojects/inst/docs/)）。
...
| 知道 `inst` 這個小專案的內部細節 | [`subprojects/inst/docs/`](../subprojects/inst/docs/) |
...
- **`inst` 的 JSON schema、執行語意、C/C++ API 逐項說明**在
  [`subprojects/inst/docs/`](../subprojects/inst/docs/)。本目錄只到「怎麼取得並連上 `aos::inst`」為止。
