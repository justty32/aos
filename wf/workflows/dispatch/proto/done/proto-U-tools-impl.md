...
> 交接書是唯一契約。規劃與**使用者 12 條裁決**在 ideas/tools/README（裁決段**壓過**規劃檔裡的建議），細節在同資料夾 `registry.md`／`description.md`／`call-loop.md`／`contacts.md`；協定 [PROTOCOL](../PROTOCOL.md)；現況 `core/agent/src/tools.cpp`、`step.cpp`、`core/agent/README.md`。
