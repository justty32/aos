...
| [feedback-and-failure](call-format/feedback-and-failure.md) | 第五輪：這個系統能不能察覺自己正在壞掉——投遞失敗**沒有回饋路徑**、失敗永遠不算失敗會**全速無限空轉**、交接協定是**自願的**、`.bad` 是規格不認識的第三種狀況、沒有背壓、沒有 change feed | 要碰 handoff／loop 的錯誤處理之前 |
