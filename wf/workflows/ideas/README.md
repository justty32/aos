...
| [agent-loop-under-clock](agent-loop-under-clock.md) | **agent 規劃第一篇**（2026-09-04）：agent 是一塊地加逐 tick 小狀態機；LLM／慢工具各生脫節小地，兩個有事 tick 中間夾空等 tick。使用者確認此走法（傾向，非裁決）；另記一次性時鐘、等待時世界會變、inotify 門鈴與三個待決問題，不重開 09 的四個工程腳位 |
