...
- **S-09-64** 那個檔必須有 `format_version`、`id`、`from`、`state`、`unit`、`updated_at`、`request`、`ext`；`state` 必須是 `queued`、`sent`、`done`、`failed` 四個之一。〔裁決 2026-09-05〕
...
- S-09-63～S-09-65 每筆一份狀態紀錄，`aos status --request` 查。〔裁決 2026-09-05〕｜S-09-66、S-09-89、S-09-90 只當進度、留原文並據此去重。〔主編補〕
