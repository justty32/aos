...
- **S-02-04** 新增一個檔必須當成定義一個名字（檔案＝名字＋內容），資料夾結構就是作用域與壽命。〔裁決 2026-09-05〕
...
- **S-02-11** `aos mv`（停時鐘＋搬＋重新登記）必須是唯一正確的搬法，細節見 [08](08-daemon.md)；直接 `mv` 的後果由 daemon 巡邏兜底。〔裁決 2026-09-05〕
