...
一共 742 條，685 條對到機器跑得動的檢查，57 條只能人工看。條款以 2026-09-05 15:03 的 spec 為準。原本拆成 14／14b／14c 三份，現已合併成一份導航（表本身抽到資料檔，見下）。
...
已抽到 [data/conformance.json](data/conformance.json)（753 列，對應 742 個不重複條款編號；一個條款偶爾對到不只一種檢查角度，所以列數比條款數多）。
