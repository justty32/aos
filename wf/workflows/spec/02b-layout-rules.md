...
- **S-02-28** `reap_after_ms` 必須是 daemon 清孤地的期限：脫節子地跑完、父超過這段時間沒來讀，daemon 連結果一起清並留紀錄。〔裁決 2026-09-05〕
- **S-02-29** `inbox_max` 必須是收件匣背壓上限，預設 `1000`；滿了就拒收，見 [07](07-call-and-delivery.md)。〔預設 2026-09-05，I-06〕
...
- **S-02-31** 「先跑完所有子地再做我的事」禁止內建；要就自己在原稿裡寫出來。〔裁決 2026-09-05〕
- **S-02-32** 一個資料夾的入口必須是一批（可以同時有好幾條串），不是一條。〔裁決 2026-09-05〕
- **S-02-33** 父開過誰、下一個開誰必須記在 `.aos/series.json`；那是資料夾層借住機器層那根接力棒，禁止另立第二根。〔裁決 2026-09-05〕
- **S-02-34** 一塊地跑起來之後必須不理頂層原稿被改；下次被點名開才重讀。要立刻生效必須停掉重開。〔裁決 2026-09-05〕

## 記憶就是地

- **S-02-35** 停掉、隔天再來，地還在就必須記得；禁止另做一個記憶容器。〔裁決 2026-09-04〕
- **S-02-36** OS 這一層必須只保證三件事：地還在、能列舉、能用 git 存檔回滾。〔裁決 2026-09-05〕
- **S-02-37** 地上放什麼、怎麼摘要、多大要砍，必須交給應用（通常是 agent 自己的圈）。〔裁決 2026-09-05〕
...
- S-02-29 `inbox_max` 預設 1000。〔預設，I-06〕
