...
- **S-09-45** `aos llm` 的退出碼必須只有四種：`0` 正常跑完、`2` 用法錯、`75` 後端或傳輸失敗、`130` 被取消；四種全都只說「跑沒跑起來」，不說可不可重試。〔裁決 2026-09-05〕
- **S-09-56** 這四種退出碼必須全歸「跑沒跑起來」那一軸；禁止從退出碼推「該不該重試」。〔裁決 2026-09-05〕
- **S-09-57** 可不可重試必須寫在狀態檔的 `ext.retryable`（布林）；包成工具封套時寫進 `error.retryable`。父禁止改看退出碼。〔裁決 2026-09-05〕
