...
← [WORKFLOWS](../WORKFLOWS.md)｜裁決總表 [ideas/verdicts](ideas/verdicts.md)
...
**讀**：[verdicts](ideas/verdicts.md) A 表、[instruction §18/§24](ideas/machine-shape/instruction.md)、[debts](ideas/machine-shape/debts.md)。
...
批 id 讓去重成為可能。
**讀**：[instruction](ideas/machine-shape/instruction.md) 全檔、[format-gaps](ideas/call-format/format-gaps.md)、[keep](ideas/call-format/keep.md)（argv 陣列、未知 key 拒絕**別動**）、`core/inst/docs/format.md`。
