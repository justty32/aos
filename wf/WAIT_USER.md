...
71. **組織設計：「cpu ≤ 20」算不算 llm 的 5 顆？**HR 部的擋點不算（default 池 20＋llm 池 5，最多 25 顆）；財務部的 cost 表把兩池加起來印。公司樣板照 HR 算法（真正擋的那一個）。**預設：照 HR 算法（cpu 不含 llm）**，與第 56、59 條同一組要一併統一。→ [報告](../proto5/notes/2026-09-25-company/README.md) §4
