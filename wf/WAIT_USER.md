...
59. **組織設計：五家同跑 llm cpu 總數超過機器上限（5×5＝25＞20）怎麼辦？**選項：(a) 每家降到 4（樣板做法，`new --llm-cpu 4`）；(b) 按排名動態分（第一名 6、最後一名 2）；(c) 允許超賣、大家排隊。**預設 (a)**（與第 56 條同一件事，可一併裁決）。→ [報告](../proto5/notes/2026-09-25-company/README.md) §4
