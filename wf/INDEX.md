...
| `proto*/` | **原型區**（鐵律 5「spec 出一部分就做原型」的產物）：`proto`／`proto2`／`proto3`／`proto3-1`／`proto3-2`／`proto4`／`proto4-1`／`proto4-2`／`proto4-3`。各版**任意語言、跟 `core/` 切開、不進 CMake**。**現行是 [`proto4-3/`](../proto4-3/README.md)**（Python：aos-exec／aos-run／aos-daemon／aos-kernel 那一系列），設計筆記在 [`proto4/notes/`](../proto4/notes/2026-09-08-ideas.md)；舊版留著當參考 |
